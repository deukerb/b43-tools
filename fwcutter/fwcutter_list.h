...
static struct extract _d5c32f14260124984ae8d5085eb5cc8a[] =
{
	{ .name = "lcn1bsinitvals26", .offset = 0x246B18, .type = EXT_IV, .length = 0x118 },
	{ .name = "n0bsinitvals22", .offset = 0x2A8168, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn0bsinitvals26", .offset = 0x245AA8, .type = EXT_IV, .length = 0x118 },
	{ .name = "ac1bsinitvals42", .offset = 0x28E6E0, .type = EXT_IV, .length = 0x248 },
	{ .name = "ucode24_lcn", .offset = 0x254AEC, .type = EXT_UCODE_3, .length = 0x891A },
	{ .name = "ht0bsinitvals26", .offset = 0x248BF8, .type = EXT_IV, .length = 0x118 },
	{ .name = "ucode24_mimo", .offset = 0x24AE90, .type = EXT_UCODE_3, .length = 0x9C58 },
	{ .name = "n20initvals36", .offset = 0x24AE60, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode15", .offset = 0x303758, .type = EXT_UCODE_3, .length = 0x7190 },
	{ .name = "b0g0bsinitvals9", .offset = 0x2E3BB8, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn405initvals35", .offset = 0x24AE50, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac1initvals42", .offset = 0x28D360, .type = EXT_IV, .length = 0x1378 },
	{ .name = "lp0bsinitvals13", .offset = 0x2E7728, .type = EXT_IV, .length = 0x118 },
	{ .name = "b0g0bsinitvals5", .offset = 0x2E1958, .type = EXT_IV, .length = 0x118 },
	{ .name = "ucode43", .offset = 0x2A3008, .type = EXT_UCODE_3, .length = 0x4 },
	{ .name = "lp0initvals16", .offset = 0x2A5188, .type = EXT_IV, .length = 0xF90 },
	{ .name = "lp1bsinitvals20", .offset = 0x2A7198, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn1initvals25", .offset = 0x241558, .type = EXT_IV, .length = 0x10D8 },
	{ .name = "b0g0initvals13", .offset = 0x2E7848, .type = EXT_IV, .length = 0xBF0 },
	{ .name = "lcn402initvals33", .offset = 0x24AE00, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn3bsinitvals21", .offset = 0x2A8040, .type = EXT_IV, .length = 0x118 },
	{ .name = "ht0initvals29", .offset = 0x248D28, .type = EXT_IV, .length = 0xF98 },
	{ .name = "n2bsinitvals19", .offset = 0x2A7148, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn1bsinitvals20", .offset = 0x2A7188, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode25_lcn", .offset = 0x2651D2, .type = EXT_UCODE_3, .length = 0x86B9 },
	{ .name = "lcn0initvals24", .offset = 0x23BB38, .type = EXT_IV, .length = 0x10E0 },
	{ .name = "lcn404initvals33", .offset = 0x24AE20, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn1bsinitvals27", .offset = 0x248D20, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn404bsinitvals33", .offset = 0x24AE28, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode22_sslpn", .offset = 0x2E0F04, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "lcn1bsinitvals25", .offset = 0x242638, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn406initvals37", .offset = 0x24AE70, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac3initvals43", .offset = 0x28E930, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn2initvals26", .offset = 0x246C38, .type = EXT_IV, .length = 0xF48 },
	{ .name = "ucode20_sslpn", .offset = 0x2D262C, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "lcn403bsinitvals33", .offset = 0x24AE18, .type = EXT_IV, .length = 0x0 },
	{ .name = "a0g0bsinitvals9", .offset = 0x2E5298, .type = EXT_IV, .length = 0x118 },
	{ .name = "n0initvals17", .offset = 0x2A6240, .type = EXT_IV, .length = 0xDD8 },
	{ .name = "ht0bsinitvals29", .offset = 0x249CC8, .type = EXT_IV, .length = 0x118 },
	{ .name = "ucode21_sslpn", .offset = 0x2D263C, .type = EXT_UCODE_3, .length = 0x7460 },
	{ .name = "sslpn1initvals20", .offset = 0x2A7180, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn0initvals16", .offset = 0x2A40D0, .type = EXT_IV, .length = 0xF90 },
	{ .name = "lcn0initvals26", .offset = 0x244B58, .type = EXT_IV, .length = 0xF48 },
	{ .name = "ucode27_sslpn", .offset = 0x2774FC, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "ucode29_mimo", .offset = 0x277504, .type = EXT_UCODE_3, .length = 0xAA20 },
	{ .name = "ucode21_sslpn_nobt", .offset = 0x2D9AA0, .type = EXT_UCODE_3, .length = 0x7460 },
	{ .name = "lp0initvals15", .offset = 0x2E9288, .type = EXT_IV, .length = 0xE68 },
	{ .name = "ucode19_sslpn", .offset = 0x2D261C, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "lcn1bsinitvals24", .offset = 0x23DE28, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn401bsinitvals33", .offset = 0x24ADF8, .type = EXT_IV, .length = 0x0 },
	{ .name = "lp0bsinitvals14", .offset = 0x2E9280, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode16_sslpn_nobt", .offset = 0x2B8DA8, .type = EXT_UCODE_3, .length = 0x7077 },
	{ .name = "n16bsinitvals30", .offset = 0x24ACB0, .type = EXT_IV, .length = 0x118 },
	{ .name = "a0g1bsinitvals13", .offset = 0x2E9158, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn402bsinitvals33", .offset = 0x24AE08, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode19_sslpn_nobt", .offset = 0x2D2624, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "ucode40", .offset = 0x28E940, .type = EXT_UCODE_3, .length = 0xA418 },
	{ .name = "lcn1initvals24", .offset = 0x23CD40, .type = EXT_IV, .length = 0x10E0 },
	{ .name = "sslpn2initvals19", .offset = 0x2A7150, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac2initvals41", .offset = 0x28D350, .type = EXT_IV, .length = 0x0 },
	{ .name = "n16initvals30", .offset = 0x249DE8, .type = EXT_IV, .length = 0xEC0 },
	{ .name = "ucode16_lp", .offset = 0x2A8190, .type = EXT_UCODE_3, .length = 0x8458 },
	{ .name = "n0initvals22", .offset = 0x2A8160, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn3initvals21", .offset = 0x2A71A0, .type = EXT_IV, .length = 0xE98 },
	{ .name = "lp1initvals22", .offset = 0x2A8180, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac2bsinitvals41", .offset = 0x28D358, .type = EXT_IV, .length = 0x0 },
	{ .name = "a0g1bsinitvals9", .offset = 0x2E53B8, .type = EXT_IV, .length = 0x118 },
	{ .name = "n0bsinitvals11", .offset = 0x2E60F0, .type = EXT_IV, .length = 0x118 },
	{ .name = "a0g1bsinitvals5", .offset = 0x2E2FB8, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn2bsinitvals26", .offset = 0x247B88, .type = EXT_IV, .length = 0x118 },
	{ .name = "ucode34_mimo", .offset = 0x28BD34, .type = EXT_UCODE_3, .length = 0x4 },
	{ .name = "n1initvals20", .offset = 0x2A7170, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn2initvals25", .offset = 0x242758, .type = EXT_IV, .length = 0x10D8 },
	{ .name = "ucode37_lcn40", .offset = 0x28BD4C, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "n0initvals16", .offset = 0x2A3018, .type = EXT_IV, .length = 0xF90 },
	{ .name = "n0bsinitvals24", .offset = 0x240238, .type = EXT_IV, .length = 0x118 },
	{ .name = "n1bsinitvals20", .offset = 0x2A7178, .type = EXT_IV, .length = 0x0 },
	{ .name = "b0g0initvals5", .offset = 0x2E0F48, .type = EXT_IV, .length = 0xA08 },
	{ .name = "b0g0initvals9", .offset = 0x2E30D8, .type = EXT_IV, .length = 0xAD8 },
	{ .name = "lcn0bsinitvals24", .offset = 0x23CC20, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn2bsinitvals25", .offset = 0x243838, .type = EXT_IV, .length = 0x118 },
	{ .name = "sslpn4bsinitvals22", .offset = 0x2A8178, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode11", .offset = 0x2F5268, .type = EXT_UCODE_2, .length = 0x7810 },
	{ .name = "n2initvals19", .offset = 0x2A7140, .type = EXT_IV, .length = 0x0 },
	{ .name = "pcm4", .offset = 0x30A8EC, .type = EXT_PCM, .length = 0x4 },
	{ .name = "ucode13", .offset = 0x2FCA6C, .type = EXT_UCODE_2, .length = 0x6CE0 },
	{ .name = "lcn0initvals25", .offset = 0x240358, .type = EXT_IV, .length = 0x10D8 },
	{ .name = "sslpn1initvals27", .offset = 0x248D18, .type = EXT_IV, .length = 0x0 },
	{ .name = "lp0bsinitvals15", .offset = 0x2EA0F8, .type = EXT_IV, .length = 0x118 },
	{ .name = "lp0initvals14", .offset = 0x2E9278, .type = EXT_IV, .length = 0x0 },
	{ .name = "lp1bsinitvals22", .offset = 0x2A8188, .type = EXT_IV, .length = 0x0 },
	{ .name = "n18initvals32", .offset = 0x24ADD0, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn405bsinitvals35", .offset = 0x24AE58, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode41", .offset = 0x298D5C, .type = EXT_UCODE_3, .length = 0x4 },
	{ .name = "lcn400initvals33", .offset = 0x24ADE0, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn0bsinitvals16", .offset = 0x2A5068, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn401initvals33", .offset = 0x24ADF0, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode33_lcn40", .offset = 0x28BD2C, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "a0g1initvals9", .offset = 0x2E47B8, .type = EXT_IV, .length = 0xAD8 },
	{ .name = "ucode32_mimo", .offset = 0x28BD24, .type = EXT_UCODE_3, .length = 0x4 },
	{ .name = "lcn400bsinitvals33", .offset = 0x24ADE8, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn404bsinitvals35", .offset = 0x24AE48, .type = EXT_IV, .length = 0x0 },
	{ .name = "n19initvals34", .offset = 0x24AE30, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac3bsinitvals43", .offset = 0x28E938, .type = EXT_IV, .length = 0x0 },
	{ .name = "n0initvals25", .offset = 0x243958, .type = EXT_IV, .length = 0x10D8 },
	{ .name = "ucode26_mimo", .offset = 0x26D898, .type = EXT_UCODE_3, .length = 0x9C60 },
	{ .name = "n0bsinitvals16", .offset = 0x2A3FB0, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn404initvals35", .offset = 0x24AE40, .type = EXT_IV, .length = 0x0 },
	{ .name = "lp2bsinitvals19", .offset = 0x2A7168, .type = EXT_IV, .length = 0x0 },
	{ .name = "n19bsinitvals34", .offset = 0x24AE38, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode20_sslpn_nobt", .offset = 0x2D2634, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "ac0bsinitvals40", .offset = 0x28D100, .type = EXT_IV, .length = 0x248 },
	{ .name = "lcn2initvals24", .offset = 0x23DF48, .type = EXT_IV, .length = 0x10E0 },
	{ .name = "sslpn4initvals22", .offset = 0x2A8170, .type = EXT_IV, .length = 0x0 },
	{ .name = "sslpn2bsinitvals19", .offset = 0x2A7158, .type = EXT_IV, .length = 0x0 },
	{ .name = "n0bsinitvals25", .offset = 0x244A38, .type = EXT_IV, .length = 0x118 },
	{ .name = "lp2initvals19", .offset = 0x2A7160, .type = EXT_IV, .length = 0x0 },
	{ .name = "n18bsinitvals32", .offset = 0x24ADD8, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn0bsinitvals25", .offset = 0x241438, .type = EXT_IV, .length = 0x118 },
	{ .name = "n0initvals11", .offset = 0x2E54D8, .type = EXT_IV, .length = 0xC10 },
	{ .name = "lcn2bsinitvals24", .offset = 0x23F030, .type = EXT_IV, .length = 0x118 },
	{ .name = "n0absinitvals11", .offset = 0x2E6210, .type = EXT_IV, .length = 0x118 },
	{ .name = "a0g0initvals5", .offset = 0x2E1A78, .type = EXT_IV, .length = 0xA08 },
	{ .name = "a0g1initvals13", .offset = 0x2E8560, .type = EXT_IV, .length = 0xBF0 },
	{ .name = "pcm5", .offset = 0x30A8F4, .type = EXT_PCM, .length = 0x520 },
	{ .name = "ucode35_lcn40", .offset = 0x28BD3C, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "ucode14", .offset = 0x303750, .type = EXT_UCODE_2, .length = 0x4 },
	{ .name = "ucode36_mimo", .offset = 0x28BD44, .type = EXT_UCODE_3, .length = 0x4 },
	{ .name = "a0g0initvals9", .offset = 0x2E3CD8, .type = EXT_IV, .length = 0xAD8 },
	{ .name = "ucode17_mimo", .offset = 0x2C9890, .type = EXT_UCODE_3, .length = 0x8D88 },
	{ .name = "lp0initvals13", .offset = 0x2E6330, .type = EXT_IV, .length = 0x13F0 },
	{ .name = "ucode25_mimo", .offset = 0x25D40C, .type = EXT_UCODE_3, .length = 0x7DC8 },
	{ .name = "lp0bsinitvals16", .offset = 0x2A6120, .type = EXT_IV, .length = 0x118 },
	{ .name = "lcn406bsinitvals37", .offset = 0x24AE78, .type = EXT_IV, .length = 0x0 },
	{ .name = "ac0initvals40", .offset = 0x28BD68, .type = EXT_IV, .length = 0x1390 },
	{ .name = "ucode30_mimo", .offset = 0x281F28, .type = EXT_UCODE_3, .length = 0x9DF8 },
	{ .name = "b0g0bsinitvals13", .offset = 0x2E8440, .type = EXT_IV, .length = 0x118 },
	{ .name = "n20bsinitvals36", .offset = 0x24AE68, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode42", .offset = 0x298D64, .type = EXT_UCODE_3, .length = 0xA2A0 },
	{ .name = "lcn407initvals38", .offset = 0x24AE80, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn1initvals26", .offset = 0x245BC8, .type = EXT_IV, .length = 0xF48 },
	{ .name = "ht0initvals26", .offset = 0x247CA8, .type = EXT_IV, .length = 0xF48 },
	{ .name = "ucode38_lcn40", .offset = 0x28BD54, .type = EXT_UCODE_3, .length = 0x1 },
	{ .name = "lcn407bsinitvals38", .offset = 0x24AE88, .type = EXT_IV, .length = 0x0 },
	{ .name = "lcn403initvals33", .offset = 0x24AE10, .type = EXT_IV, .length = 0x0 },
	{ .name = "ucode16_sslpn", .offset = 0x2B05EC, .type = EXT_UCODE_3, .length = 0x87B5 },
	{ .name = "ucode16_mimo", .offset = 0x2BFE24, .type = EXT_UCODE_3, .length = 0x9A68 },
	{ .name = "n0bsinitvals17", .offset = 0x2A7020, .type = EXT_IV, .length = 0x118 },
	{ .name = "a0g1initvals5", .offset = 0x2E2488, .type = EXT_IV, .length = 0xA08 },
	{ .name = "n0initvals24", .offset = 0x23F150, .type = EXT_IV, .length = 0x10E0 },
	{ .name = "lp1initvals20", .offset = 0x2A7190, .type = EXT_IV, .length = 0x0 },
	{ .name = "a0g0bsinitvals5", .offset = 0x2E2E98, .type = EXT_IV, .length = 0x118 },
	{ .name = "ucode9", .offset = 0x2EF454, .type = EXT_UCODE_2, .length = 0x5E00 },
	{ .name = "ucode5", .offset = 0x2EA220, .type = EXT_UCODE_2, .length = 0x5230 },
	{ .name = "ucode22_mimo", .offset = 0x2E0F0C, .type = EXT_UCODE_3, .length = 0x4 },
	EXTRACT_LIST_END
};
...
static const struct file files[] = 
{
	...
	},
	{
		...
		.name		= "wl_apsta.o",
		.ucode_version	= "802.204",
		.md5		= "d5c32f14260124984ae8d5085eb5cc8a",
		.flags		= FW_FLAG_LE | FW_FLAG_V4,
		.extract	= _d5c32f14260124984ae8d5085eb5cc8a,
	},
};
